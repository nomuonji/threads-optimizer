            ...
            <div className="space-y-4">
                        ...
                        {postSchedule.map((time, index) => (
                            <div key={index} className="flex items-center gap-1">
                                <input
                                    ...
                                    className="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm p-1 border"
                                />
                ...
                <div className="flex justify-end gap-2">
                    ...
                    <button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="rounded-md bg-primary px-4 py-2 text-sm font-semibold text-white transition hover:opacity-90 disabled:opacity-50"
                    >
