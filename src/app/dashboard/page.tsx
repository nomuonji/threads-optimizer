...
export default async function DashboardPage() {
    ...
    const [apiUsageResult, accountsResult, systemStatusResult] = await Promise.allSettled([
        getRapidApiUsage(),
        getAccounts(),
        getSystemStatus(),
    ]);
    ...
    const systemStatus = systemStatusResult.status === "fulfilled" ? systemStatusResult.value : undefined;
