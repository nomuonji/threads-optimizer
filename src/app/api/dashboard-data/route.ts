...
import { fetchRecentPosts, fetchTopPosts, getSystemStatus } from "@/lib/services/firestore.server";
...
export async function GET(request: Request) {
    try {
        ...
        return NextResponse.json({ ok: true, accountData, drafts, systemStatus });
